        ...
        <>
            <div className="sm:px-16 px-6 w-full flex items-center py-4 bottom-0 z-20 bg-primary ">
                ...
                <ul className='flex items-center xl:gap-5 sm:gap-4 gap-2'>
                    ...
                    <li onClick={() => window.open("https://github.com/Rohit-Yadavv", "_blank")} className='contact_icon cursor-pointer'>
                        <img src={GitHub} className='sm:w-20 w-24 object-contain' alt='facebook' />
                    </li>
                    ...
                    <li onClick={() => window.open("https://www.linkedin.com/in/rohit-yadav-240448255/", "_blank")}  className='contact_icon cursor-pointer'>
                        <img src={LinkedIn} className='sm:w-20 w-24 object-contain' alt='linkedin' />
                    </li>
                    <li onClick={() => window.open("mailto:rk4740779@gmail.com")} className='contact_icon cursor-pointer'>
                        <img src={Email} className='sm:w-20 w-24 object-contain' alt='linkedin' />
                    </li>
                </ul>
            </div>
